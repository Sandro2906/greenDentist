...
const NavBar = () => {
  ...
  return (
    <div className='w-full z-20 h-20 flex justify-between items-center px-7 md:px-10 lg:px-20'>
        ...
        <div className='w-[400px] hidden h-16 justify-center items-center bg-emerald-300 font-semibold text-xl text-blue-700 lg:flex'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
